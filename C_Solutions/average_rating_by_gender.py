...
df_merged = (df_merged
             ...
             .withColumn("Age_Group", when(col("age") < 11, lit("1-10")).otherwise(when(col("age") < 21, lit("11-20")).otherwise(when(col("age") < 31, lit("21-30")).otherwise(when(col("age") < 41, lit("31-40")).otherwise(when(col("age") < 51, lit("41-50")).otherwise(when(col("age") < 61, lit("51-60")).otherwise(when(col("age") < 71, lit("61-70")).otherwise(when(col("age") < 81, lit("71-80")).otherwise(when(col("age") < 91, lit("81-90")).otherwise(when(col("age") < 101, lit("91-100")).otherwise(when(col("age") > 100, lit("_101+")))))))))))))
