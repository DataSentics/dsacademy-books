...
def best_rated_popular_books_after(from_year=2000, min_no_of_ratings=200):
    """The function takes 2 arguments to specify the desired year to filter by and a minimum number of ratings/book
    for a customizable ranking, all as integers, and returns a dataframe with the results"""
