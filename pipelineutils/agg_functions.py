...
def best_rated_popular_books(min_no_of_ratings=200):
    """The function takes one argument, a minimum number of ratings/book for a customizable ranking,
...
def best_rated_popular_books_after(from_year=2000, min_no_of_ratings=200):
    """The function takes 2 arguments to specify the desired year to filter by and a minimum number of ratings/book for a customizable ranking,
    all as integers, and returns a dataframe with the results"""
...
def best_10_books_by_sex_age_country(sex, age_interval, country, min_no_of_ratings):
    """The function takes 4 arguments, 'sex' as a string representing the gender M or F of the reviewer,
    'country' as a string representing the reviewers country a list of two integers as values for 'age_interval'
    and a minimum number of ratings/book, all act as filters, the function returns a dataframe with the results"""
