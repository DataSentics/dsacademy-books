...
books_path_upload_2 = 'abfss://{}@adapeuacadlakeg2dev.dfs.core.windows.net/'.format('03cleanseddata') + 'daniela-vlasceanu-books/silver/books'
...
spark.sql(
    "CREATE OR REPLACE TABLE books_silver AS SELECT * FROM books_silver_tempView"
)
