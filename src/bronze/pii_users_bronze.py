...
pii_path_reading= 'abfss://{}@adapeuacadlakeg2dev.dfs.core.windows.net/'.format('01rawdata')+'books_crossing/users-pii.json'
#path for writing the json as parquet
pii_path_writing = 'abfss://{}@adapeuacadlakeg2dev.dfs.core.windows.net/'.format('02parseddata') + 'AN_Books/users_pii'
