...
file_location = "wasbs://" + blob_container + "@" + storage_account_name + ".blob.core.windows.net/books_crossing"

# GENERAL_PATH = '@adapeuacadlakeg2dev.blob.core.windows.net/books_crossing'


RAW_FILES = f"{file_location}"
...
books_bronze_path = f"{RAW_FILES}/books_bronze"
